...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { favcount: @name.favcount, gender: @name.gender, means: @name.means, name: @name.name } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { favcount: @name.favcount, gender: @name.gender, means: @name.means, name: @name.name } }, as: :json
    assert_response 200
  end
